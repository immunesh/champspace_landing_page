      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className={`reveal ${isVisible ? "visible" : ""}`}>
          ...
          <div className={`glass-strong border border-indigo-500/20 rounded-3xl p-8 mb-10 text-left glow-indigo reveal d-200 ${isVisible ? "visible" : ""}`}>
            {sent ? (
              <div className="text-center py-6">
                ...
                <button onClick={handleReset} className="mt-4 text-xs text-indigo-400 hover:text-indigo-300 transition-colors underline underline-offset-2">
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea rows={4} value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Tell us what's on your mind..."
          ...
          <div className={`flex flex-wrap items-center justify-center gap-4 reveal d-300 ${isVisible ? "visible" : ""}`}>
            ...
            {[
              { icon: Mail,     label: "Email",    href: "mailto:champspace6@gmail.com" },
              { icon: Phone,    label: "WhatsApp", href: "https://wa.me/919027396563" },
              { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/company/110208947/" },
              { icon: Github,   label: "GitHub",   href: "https://github.com/immunesh" },
