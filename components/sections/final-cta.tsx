  ...
  return (
    <section className="relative py-24 px-4 overflow-hidden bg-gradient-to-br from-[#0a0f14] via-[#0a0a2e] to-[#0a0f14] animate-fade-in-up font-geist">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-primary/10 to-accent/10 rounded-2xl blur-3xl"></div>
        ...
        <div className="relative z-10 p-12 md:p-16 rounded-2xl bg-accent/10 text-center space-y-6">
          ...
          <p className="text-lg text-slate-400 max-w-xl mx-auto">
            Don't wait for a breach. Get protected today with our enterprise-grade security platform.
          </p>
