...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Absolutely. Our platform works with AWS, Azure, Google Cloud, and private data centers. We support hybrid architectures and offer flexible deployment options.",
    },
    {
    ...
    <section className="relative py-24 px-4 overflow-hidden bg-gradient-to-br from-[#0a0f14] via-[#0a0a2e] to-[#0a0f14] animate-fade-in-up font-geist">
      <div className="max-w-4xl mx-auto">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-lg text-slate-400">Quick answers about our platform</p>
        </div>
