  ...
  const values = [
    {
      ...
      description: 'Every decision prioritizes protecting our clients from digital threats.'
    },
    {
      icon: Users,
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Protecting enterprises worldwide from digital threats with intelligent, AI-powered solutions.
            </p>
          </div>
          ...
          <div className="mb-10 ">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              To empower organizations of all sizes with enterprise-grade security that's intelligent, intuitive, and always one step ahead of threats. We believe that security should never compromise usability, and that protecting your systems shouldn't require a PhD in security.
            </p>
          </div>
