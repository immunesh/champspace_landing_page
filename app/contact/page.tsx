          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {contactInfo.map((info, idx) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 rounded-lg bg-linear-to-br from-primary to-accent flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-card/50 border-2 border-primary/30 rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-linear-to-r from-primary to-accent text-background font-semibold  rounded-full py-3  hover:shadow-lg"
                >
