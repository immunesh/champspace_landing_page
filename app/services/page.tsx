  ...
  const services = [
    {
      ...
      description: 'AI-powered real-time detection and automatic response to threats across your entire infrastructure.',
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Comprehensive security solutions designed to protect, detect, and respond to threats.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-14 h-14 rounded-lg bg-linear-to-br from-primary to-accent flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  ...
                  <Button className="bg-linear-to-r from-primary to-accent text-background font-semibold  rounded-full w-full hover:shadow-lg ">
                    Learn More
                  </Button>
                </div>
              )
          ...
          {/* CTA Section */}
          <div className="mt-20 bg-linear-to-r from-primary/10 to-accent/10 border-2 border-primary/30 rounded-2xl p-12 text-center">
            ...
            <Button className="bg-linear-to-r from-primary to-accent text-background font-semibold  rounded-full px-8 ">
              Schedule Assessment
            </Button>
          </div>
        </section>
