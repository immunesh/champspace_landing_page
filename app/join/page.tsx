          ...
          {step !== 4 && (
            <div className="text-center mb-16">
              <h1 className="text-5xl md:text-6xl font-sbold mb-6 ">
                Join <img src="/logo.png" alt="Logo" className="inline h-8 align-middle" style={{display:'inline',verticalAlign:'middle',marginLeft:'0.5rem'}} />
              </h1>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Get started with our enterprise-grade security in minutes
              </p>
            </div>
          )}
            ...
            <div className="md:col-span-2">
              {step === 4 ? (
                ...
                <div className="bg-card/50 border-2 border-accent rounded-2xl p-12 text-center ">
                  <div className="w-20 h-20 rounded-full bg-linear-to-br from-primary to-accent flex items-center justify-center  mx-auto mb-6">
                  ...
                  <Button className="bg-linear-to-r from-primary to-accent text-background font-sbold  rounded-full ">
                    Go to Dashboard
                  </Button>
                </div>
              ) : (
                  ...
                  <div className="flex gap-4 mt-8">
                    ...
                    {step < 3 ? (
                      <Button
                        type="button"
                        onClick={handleNext}
                        className="flex-1 bg-linear-to-r from-primary to-accent text-background font-semibold  rounded-full "
                      >
                      ...
                      <Button
                        type="submit"
                        className="flex-1 bg-linear-to-r from-primary to-accent text-background font-sbold  rounded-full "
                      >
                        Create Account
                      </Button>
                    )}
